...
<body>
	...
	<div class="header3">
		...
		<div class="h3_right">
			...
			<div class="tsc" onclick="window.location.href='shopCar.jsp'">
					...
					<li class="c4_b5_c_box">
						...
						<div class="c4_b5_c_box_pic">
							<div class="c4b5_pic_view">
								<a href="viewBook.action?book_id=${book.id }"><img src="images/list_p1.png"></a>
							</div>
						</div> <!--价钱-->
						<div class="c4_b5_c_box_txt">
							<h1>￥ ${book.price }</h1>
							<h2>
								<a href="viewBook.action?book_id=${book.id }">${book.name }</a>
							</h2>
						</div> <!--购买等操作-->
						<div class="c4b5_el">
							<div class="c4b5_el_x">
						...
						<ul class="c4b5_option">
							<li class="shopcar_box"><span class="shopcar01"></span><a
								href="addShopCar.action?num=1&book_id=${book.id }">加入购物车</a></li>
						</ul>
					</li>
				</c:forEach>
					<!-- <li class="c4_b5_c_box">
						...
						<div class="c4_b5_c_box_txt">
							<h1>￥ 50</h1>
							<h2>
								<a href="viewBook.html">Java编程思想</a>
							</h2>
						</div> 购买等操作
						<div class="c4b5_el">
							<div class="c4b5_el_x">
