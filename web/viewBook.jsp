...
<div class="container5">
	<div class="cn5_top">
		<div class="cn5_top_x center01">
			<a class="font20" href="#">书籍</a> > <a
				href="listBooks.action?category_id=${book.category.parent.id }&type=parent">${book.category.parent.name }</a>
> <a
	href="listBooks.action?category_id=${book.category.id }&type=child">${book.category.name }</a>
</div>
...
<div class="cn5topy_2">
	...
	<form action="addShopCar.action" id="addCar">
